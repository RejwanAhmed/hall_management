        ...
        <table class = "table table-bordered table-hover text-center table-lg-responsive">
            ...
            while($row = mysqli_fetch_assoc($run))
            {
                ...
                <tr>
                    ...
                    <td><a class = "btn btn_color" href="student_monthly_due.php?id=<?php echo $row['id']?>"><b><span><i class="fas fa-file-invoice-dollar"></i></span> Payment</b></a></td>
                </tr>
                <?php
            }
            ?>
        ...
        <div class="col-lg-12 col-12">
            <div class="card shadow-lg">
                <div class="card-header">
                    <h3 class ="text-center card_header_color text-uppercase">All Student Payment Information <span><i class="far fa-money-bill-alt"></i></span></h3>
                </div>
                <div class="card-body">
                    ...
                    if(isset($_POST['search']))
                    {
                        ...
                        if($count==1)
                        {
                            ...
                            <script>
                                ...
                                window.location = "student_payment_information.php";
                            </script>
                            <?php
                        }
                    ...
                    else
                    {
                        ...
                        <div class="col-lg-12 col-12">
                            <?php
                            $run = 0;
                            $page_name = 'student_payment_information';
