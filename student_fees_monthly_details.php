...
else if(isset($_GET['year']))
{
    ...
    $year_validation_qry = "SELECT * FROM `student_payment_information` WHERE `year` = '$_GET[year]' LIMIT 1";
                ...
                <div class="card-header">
                    <div class="row justify-content-center">
                        <div class="col-lg-12 col-md-12 col-12">
                            <h3 class ="text-center card_header_color text-uppercase">Year <?php echo $_GET['year']?> Monthly Details <span><i class="fas fa-chart-bar"></i></span></h3>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <table class = "table table-bordered table-hover text-center table-responsive-lg">
                        ...
                        <?php
                        $qry = "SELECT * , SUM(`amount`), COUNT(`student_id`) FROM `student_payment_information` WHERE `year` = '$_GET[year]' GROUP BY `month`";
                        ...
                        while($row = mysqli_fetch_assoc($run))
                        {
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['COUNT(`student_id`)']?></td>
