...
<?php
    function get_row_count()
    {
        ...
        $sql = "SELECT COUNT(`id`) as total_row FROM `student_information` WHERE `status` = 1";
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <h3 class ="text-center card_header_color text-uppercase">Current Student <span><i class="fas fa-info-circle"></i></span></h3>
                        </div>
                        <div class="col-lg-3 col-md-3 col-12 text-center">
                            <a class = "btn btn-danger" href="add_student.php"><b><span><i class="far fa-plus-square"></i></span> Student</b></a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
