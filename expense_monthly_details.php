...
else if(isset($_GET['year']))
{
    ...
    $year_validation_qry = "SELECT * FROM `expense_information` WHERE `year` = '$_GET[year]' LIMIT 1";
                ...
                <div class="card-header">
                    <div class="row justify-content-center">
                        <div class="col-lg-6 col-md-6 col-12">
                            <h3 class ="text-center card_header_color text-uppercase">Year <?php echo $_GET['year']?> Expense Details <span><i class="fas fa-info-circle"></i></span></h3>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <table class = "table table-bordered table-hover text-center table-responsive-lg">
                        ...
                        <?php
                        $expense_information_qry_month_wise = "SELECT *  FROM `expense_information` WHERE `year` = '$_GET[year]'";
                        $run_expense_information_qry_month_wise = mysqli_query($conn, $expense_information_qry_month_wise);
                        ...
                        while($row = mysqli_fetch_assoc($run_expense_information_qry_month_wise))
                        {
                            ?>
                            <tr>
