...
<?php
    function get_row_count()
    {
        ...
        $sql = "SELECT COUNT(`id`) as total_row FROM `expense_information` ";
    ...
    function display_content($run,$offset,$total)
    {
        ...
        if(empty($run))
        {
            $donation_information_qry = "SELECT *  FROM `expense_information` ORDER BY `expense_date` DESC LIMIT $offset, $total";
        ...
        <table class = "table table-bordered table-hover text-center table-responsive-lg">
            ...
            while($row = mysqli_fetch_assoc($run))
            {
                ...
                <tr>
                    ...
                    <td>
                        <a class = "btn btn_color" href="update_expense_information.php?id=<?php echo $row['id']?>"><b><span><i class="fas fa-edit"></i></span> Modify</b></a>
                    </td>
                ...
                <div class="card-header">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <h3 class ="text-center card_header_color text-uppercase">All Expense Information <span><i class="fas fa-info-circle"></i></span></h3>
                        </div>
                        <div class="col-lg-3 col-md-3 col-12 text-center">
                            <a href="add_expense.php" class = "btn btn-danger"><b><span><i class="far fa-plus-square"></i></span> Expense</b></a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <?php
                        if(isset($_POST['search']))
                        {
                            ...
                            $search_qry = "SELECT * FROM `expense_information` WHERE ";
                            $count=1;
                            if($year!=NULL)
                            {
                                $count++;
...
<script>
    function deleteConfirmation(id)
    {
        ...
        if(del == true)
        {
            window.location='delete_expense_information.php?id='+id;
        }
    }
</script>
